...
agent any
 ...
 post {
    ...
    success {
           slackSend (baseUrl: "https://cs5500.slack.com/services/hooks/jenkins-ci/", token: "3hPnAaaFQogsjLuXnfu1Jjw1", channel: "#cs5500-team-102-f18", color: '#00FF00', message: "SUCCESSFUL: Job '${env.JOB_NAME}")
            }
    failure {  
           slackSend (baseUrl: "https://cs5500.slack.com/services/hooks/jenkins-ci/", token: "3hPnAaaFQogsjLuXnfu1Jjw1", channel: "#cs5500-team-102-f18", color: '#FF0000', message: "FAILED: Job '${env.JOB_NAME}")
            }
       }
} //pipeline
