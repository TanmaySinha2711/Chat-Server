...
public class Buddy {
	...
	/** Map of names to Buddy's for internal use only. */
	...
	/** This method returns the instant map so user names can be verified for testing
	 * @return A map instance 
	 */
	public static ConcurrentMap<String, Buddy> getInstanceMap(){
		return INSTANCES;
	}
}
